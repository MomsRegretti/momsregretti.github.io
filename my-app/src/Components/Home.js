...
function Home() {
    return (
        <div style={{ backgroundColor: "#121212", minHeight: '900px', display: 'flex', direction: 'row', margin: 'auto' }}>
            <div className = 'fox' style={{ margin: 'auto', width: '50%', background:'#373737' }} id='pic'>
