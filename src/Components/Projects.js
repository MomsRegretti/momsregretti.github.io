...
function Projects({projectsRef}) {
  return (
    <div style={{paddingTop:'40px'}} ref={projectsRef} id='projects'>
      ...
      <div className='ProjectCard'>
        ...
        <div>
          ...
          <iframe style={{borderRadius:'15px'}} width="66%" height="600px" src="https://www.youtube.com/embed/kWflLS3Hmvg" title="Team Canyon Demo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen = "true"></iframe>
      ...
      <h2 style={{paddingTop: '15px'}}>UFC Fight Analyzer</h2>
        <div>
          ...
          <img style={{borderRadius:'15px'}} width="66%" height="600px" src='https://cdn.discordapp.com/attachments/1028056914778656883/1109369718403518525/image.png' alt='UFC Fight Analyzer'></img>
          <h3>Under the hood:</h3>
          <ul style={{listStylePosition: "inside"}}>
      ...
      <h2 style={{paddingTop: '15px'}}>Trivia Champions</h2>
        <div>
          ...
          <img style={{borderRadius:'15px'}} width="66%" height="600px" src='https://cdn.discordapp.com/attachments/1028056914778656883/1109354708025475072/image.png' alt='Trivia Champions'></img>
          <h3>Under the hood:</h3>
          <ul style={{listStylePosition: "inside"}}>
